...
function required(){for(const name of["memory","hta_abi_version","hta_alloc","hta_dealloc","hta_start","hta_next_event","hta_deliver","hta_cancel","hta_drop_task"])if(!(name in instance.exports))throw new Error(`hta/export-missing: ${name}`);if(instance.exports.hta_abi_version()!==1)throw new Error("hta/version-unsupported");}
