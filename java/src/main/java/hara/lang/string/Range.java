 ...
 *
 * <p>The objects need to either be implementations of {@code Comparable} or you need to supply a
 * {@code Comparator}.
 *
...
public final class Range<T> implements Serializable {
   ...
   */
  public static <T extends Comparable<T>> Range<T> between(
   ...
   * Obtains a range with the specified minimum and maximum values (both inclusive).
   *
   * <p>The range uses the specified {@code Comparator} to determine where values lie in the range.
   *
   * <p>The arguments may be passed in the order (min,max) or (max,min). The getMinimum and
   * getMaximum methods will return the correct values.
   *
   ...
   * @return the range object, not null
   * @throws IllegalArgumentException if either element is null
   * @throws ClassCastException if using natural ordering and the elements are not {@code
   *     Comparable}
   */
