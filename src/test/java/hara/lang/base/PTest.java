...
public class PTest {
    ...
    public void testUncheckedCharCast() {
        assertEquals((char) (Character.MAX_VALUE + 1), P.Cast.uncheckedCharCast(Character.MAX_VALUE + 1));
    }
    ...
    public void testUncheckedLongCast() {
        assertEquals(Long.MIN_VALUE, P.Cast.uncheckedLongCast(BigInteger.valueOf(Long.MAX_VALUE).add(BigInteger.ONE)));
    }
