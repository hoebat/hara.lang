...
public class ZipTest {
    ...
    public void testPrewalk() {
        Vector root = Vector.Standard.from(null, 1, Vector.Standard.from(null, 2, 3), 4);
        Zipper zipper = Zip.zipper(root);
        Zipper walked = Zip.prewalk(zipper, n -> {
            if (n instanceof Integer && (Integer) n == 2) {
                return 99;
            }
            return n;
        });
        assertTrue(hara.lang.base.Eq.eq(
    ...
    public void testPostwalk() {
        Vector root = Vector.Standard.from(null, 1, Vector.Standard.from(null, 2, 3), 4);
        Zipper zipper = Zip.zipper(root);
        Zipper walked = Zip.postwalk(zipper, n -> {
            if (n instanceof Integer && (Integer) n == 2) {
                return 99;
            }
            return n;
    ...
    public void testUpdateElements() {
        ...
        assertTrue(hara.lang.base.Eq.eq(
            hara.lang.data.List.Standard.from(null, 0, 1, 2, 3),
            zipper.currentNode()
        ));
    }
    ...
    public void testUpdateElementsWithList() {
        ...
        Zipper updatedZipper = Zip.updateElements(zipper, hara.lang.data.List.Standard.from(null, 9, 8, 7));
