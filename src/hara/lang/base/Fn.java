...
public interface Fn {
	...
	public interface H {
		...
		public class Comp implements I.OFn {
			...
			public Comp(Object... fns) {
				...
				_fns = It.toArray(It.map(it, T::toFn), I.Fn.class);
			}
	...
	public static Ut.Counter counter(int start) {
		return new Ut.Counter(start);
	}
	
	public static <V> Ut.Volatile<V> vlt(V val) {
	...
	@SafeVarargs
	public static <F> I.OFn comp(F... fns) {return new H.Comp(fns);}
