...
public interface CFn extends Callable, Runnable{
	...
	default Object apply(Object arg1, Object arg2) {
	...
	default Object applyTo(I.Seq<Object> arglist) {
	...
	static public Object applyToHelper(CFn ifn, I.Seq<Object> arglist) {
		...
		case 0:
			...
			return ifn.invoke();
		case 1:
			return ifn.invoke(ret1(arglist.first(), arglist = null));
		case 2:
			return ifn.invoke(arglist.first(), ret1((arglist = arglist.next()).first(), arglist = null));
		case 3:
			return ifn.invoke(arglist.first(), (arglist = arglist.next()).first(),
					ret1((arglist = arglist.next()).first(), arglist = null));
		case 4:
			return ifn.invoke(arglist.first(), (arglist = arglist.next()).first(), (arglist = arglist.next()).first(),
					ret1((arglist = arglist.next()).first(), arglist = null));
		case 5:
			return ifn.invoke(arglist.first(), (arglist = arglist.next()).first(), (arglist = arglist.next()).first(),
					(arglist = arglist.next()).first(), ret1((arglist = arglist.next()).first(), arglist = null));
		case 6:
			return ifn.invoke(arglist.first(), (arglist = arglist.next()).first(), (arglist = arglist.next()).first(),
					(arglist = arglist.next()).first(), (arglist = arglist.next()).first(),
					ret1((arglist = arglist.next()).first(), arglist = null));
		case 7:
			return ifn.invoke(arglist.first(), (arglist = arglist.next()).first(), (arglist = arglist.next()).first(),
					(arglist = arglist.next()).first(), (arglist = arglist.next()).first(),
		...
		default:
			return ifn.invoke(arglist.first(), (arglist = arglist.next()).first(), (arglist = arglist.next()).first(),
					...
					Sq.toArray(ret1(arglist.next(), arglist = null)));
		}
	}
