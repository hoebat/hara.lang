...
import hara.lang.base.P;
import hara.lang.base.Ut;

public interface Deque<E> extends Data.DequeType<E> {
	...
	public interface Base<E> extends Deque<E>, I.Assoc<Integer, E>, I.ObjType {
	...
	public class Mutable<E> extends Data.RefType.MT implements Base<E>, I.ToPersistent {
		...
		public Mutable() {
			this(null, Deque.DEFAULT_CAPACITY);
		}

		public Mutable(I.Metadata meta, int capacity) {
			super(meta);
			_elements = new Object[Math.max(1, 1 << P.Bits.log2Ceil(capacity))];
			_size = 0;
			_offset = 0;
