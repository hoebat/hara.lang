...
public interface Std {
  ...
  public interface T {
    ...
    @SuppressWarnings({"unchecked", "rawtypes"})
    public interface Tup1<A> extends Data.SequentialType, Data.LinearType {
    ...
    @SuppressWarnings({"unchecked", "rawtypes"})
    public interface Tup5<A, B, C, D, E>
        extends Tup4<A, B, C, D>, Data.SequentialType, Data.LinearType {
    ...
    public class Seq<E> extends Obj.PT implements Data.SequentialType<E>, Data.LinkedType<E> {
    ...
    public class Cons<E> extends Obj.PT implements Data.SequentialType<E>, Data.LinkedType<E> {
