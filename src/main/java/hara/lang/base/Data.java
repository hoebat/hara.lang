...
public interface Data {
  ...
  public interface SetType<E>
      extends IColl<E>, IObjType, IDissoc<E>, IFind<E, E>, UnOrderedType<E>, IFn<E, E, E> {
    ...
    default boolean equality(Object obj) {
      if (obj instanceof SetType) {
        return (count() == ((SetType) obj).count())
            && It.every(this.iterator(), (e) -> ((SetType) obj).find(e) != null);
  ...
  public interface SequentialType<E>
      extends Iterable<E>, ICount, IEquality, IHash, IObjType, OrderedType<E> {
    ...
    default boolean equality(Object obj) {
      if (obj instanceof SequentialType) {
        return (count() == ((SequentialType) obj).count())
            && Eq.eqIterator((Iterator) this.iterator(), ((SequentialType) obj).iterator());
