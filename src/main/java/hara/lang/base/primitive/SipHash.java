...
public interface SipHash {
   ...
   *
   * <p>Requires initial state being manually provided (to avoid allocation). The compression rounds
   * must also be provided, as nothing will be validated in this layer (such as defaults).
   *
