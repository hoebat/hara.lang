...
def refactor():
    files = [
        'src/main/java/hara/lang/data/Set.java',
        'src/main/java/hara/lang/data/List.java',
        'src/main/java/hara/lang/data/Map.java',
        'src/main/java/hara/lang/data/OrderedMap.java',
        'src/main/java/hara/lang/data/OrderedSet.java',
        'src/main/java/hara/lang/data/Tuple.java'
    ]
    ...
    for filepath in files:
        ...
        # Replace IRefType.MT -> ObjMutable (just in case IRefType.MT was missed or IRefType.ObjMutable naming)
